            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                <div className="flex items-center space-x-3">
                  ...
                  <p className="opacity-50 text-sm">5489 Ratings</p>
            ...
            <Grid container spacing={7}>
              ...
              <Grid item xs={5}>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <p className="opacity-60">5689 Ratings</p>
                </div>
                      ...
                      <LinearProgress
                        sx={{
                          ...
                          "& .MuiLinearProgress-barColorPrimary": {
                            backgroundColor: alpha("#08A045", 0.7),
                          },
                        }}
                        variant="determinate"
                        value={50}
                    ...
                    <Grid item xs={7}>
                      <LinearProgress
                        sx={{
                          ...
                          height: 7,
                          "& .MuiLinearProgress-barColorPrimary": {
                            backgroundColor: alpha("#21D375", 0.7),
                          },
                        }}
                        variant="determinate"
                        value={45}
                    ...
                    <Grid item xs={7}>
                      <LinearProgress
                        sx={{
                          ...
                          height: 7,
                          "& .MuiLinearProgress-barColorPrimary": {
                            backgroundColor: alpha("#FFEB3B", 0.7),
                          },
                        }}
                        variant="determinate"
                        value={40}
                    ...
                    <Grid item xs={7}>
                      <LinearProgress
                        sx={{
                          ...
                          height: 7,
                          "& .MuiLinearProgress-barColorPrimary": {
                            backgroundColor: alpha("#ee6b6e", 0.8),
                          },
                        }}
                        variant="determinate"
                        value={20}
